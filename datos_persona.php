...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    ...
    <form id="formulario" action="datos_persona.php" method="post">
        ...
        $consulta = "select * from personas, cargo where personas.codigo_cargo=cargo.codigo ";
        ...
        while ($columna = mysqli_fetch_array($resultado)) {
            ...
            echo "<td>" . $columna['codigo_empleado']  . "   </td>  <td>" . $columna['celular'] . "</td> <td>" . $columna['nombre'] . "</td> ";
            echo "</tr>";
        }
        echo "</table>";
