...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-11-2019 a las 04:54:38
...
INSERT INTO `contrato` (`numero`, `fecha_inicio`, `fecha_fin`, `codigo_cargo`, `codigo_empleado`, `clasificacion`) VALUES
(2, '2019-10-24', '2019-12-24', '2', '102050', NULL),
(3, '2019-10-24', NULL, '1', '102030', NULL),
(4, '2019-10-24', NULL, '3', '102040', NULL);
...
CREATE TABLE `personas` (
  ...
  `codigo_cargo` varchar(15) COLLATE utf8_spanish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;
...
INSERT INTO `personas` (`dni`, `nombres`, `apellidos`, `direccion`, `codigo_empleado`, `celular`, `codigo_cargo`) VALUES
('1070626808', 'cesar estiven', 'mesa medrano', 'mza 12a casa 4', '102030', '3114906018', NULL),
('1111193174', 'jhireth zaray', 'gonzalez flores', 'calle 8 # 5-87', '102040', '3154747232', NULL),
('1234567890', 'nesly dayana', 'gonzalez flores', 'calle 8 # 5-87', '102050', '3114906019', NULL);
...
ALTER TABLE `personas`
  ...
  ADD KEY `personas_cargo_fk` (`codigo_cargo`);
...
--
ALTER TABLE `personas`
  ADD CONSTRAINT `personas_cargo_fk` FOREIGN KEY (`codigo_cargo`) REFERENCES `cargo` (`codigo`);
